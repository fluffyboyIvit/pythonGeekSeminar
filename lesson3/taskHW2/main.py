...
favoritefilm = []
length = int(input("сколько фильмов хотите добивить: "))
for i in range(length):
    searchFilm = input("Введите название фильма: ")
    if searchFilm in films:
        favoritefilm.append(searchFilm)
    else: print(f"Ошибка: фильма {searchFilm} у нас нет :( ")
print("Ваш список любимых фильмов: ", favoritefilm)
